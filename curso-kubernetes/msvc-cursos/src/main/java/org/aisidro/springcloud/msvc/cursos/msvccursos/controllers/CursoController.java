package org.aisidro.springcloud.msvc.cursos.msvccursos.controllers;
...
import org.aisidro.springcloud.msvc.cursos.msvccursos.services.CursoService;
...
public class CursoController {
        ...
        try{
          o =  service.asignarUsuarioCurso(usuario,cursoId);
            ...
            return  ResponseEntity.status(HttpStatus.NOT_FOUND).body(Collections.singletonMap("Mensaje","No existe el usuario" +
                    " por el id o error en la comunicacion :" + e.getMessage()));
        }
        if(o.isPresent()){
    ...
    public ResponseEntity<?>crearUsuario(@RequestBody Usuario usuario,@PathVariable Long cursoId){
        ...
        try{
            ...
            return  ResponseEntity.status(HttpStatus.NOT_FOUND).body(Collections.singletonMap("Mensaje","No se pudo crear el usuario" +  e.getMessage()));
        }
        if(o.isPresent()){
            return ResponseEntity.status(HttpStatus.CREATED).body(o.get());
        }
